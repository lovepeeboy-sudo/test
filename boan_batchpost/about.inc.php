...
cpheader();
showtips(lang(BOAN_BATCHPOST_NAME, 'about'));
showtableheader(lang(BOAN_BATCHPOST_NAME, 'apps'));
$row=array(
    "<iframe width=\"1600\" height=\"768\" src=\"https://addon.dismall.com/?@86923.developer\" ></iframe>",
);
showtablerow('','',$row);
showtablefooter();